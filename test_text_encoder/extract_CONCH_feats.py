...
# ============================================================
# CONCH loader (matches your notebook)
# ============================================================
def load_conch_model_and_preprocess(project_root: str, checkpoint_path: str, model_cfg: str, device: torch.device):
...
def encode_images(model, x: torch.Tensor) -> torch.Tensor:
    ...
    if hasattr(model, "encode_image"):
        # z = model.encode_image(x) # saves NORM DEEP feats for concept prior alignment 
        z = model.encode_image(x, proj_contrast=False, normalize=False) ## NEW to save unnorm feats
